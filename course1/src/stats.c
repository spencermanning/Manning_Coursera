...
#include <stdlib.h> // For the cmpfunc and qsort functions!
#include <math.h> // For the cmpfunc and qsort functions!
#include "../include/common/platform.h" //Recently added for print_array function
...
int main2() {
  ...
  float median = find_median(sorted, input2); // MODIFIED: USED TO HAVE TestAsInt as first parameter
  float mean = find_mean(sorted, input2); // MODIFIED: USED TO HAVE TestAsInt as first parameter
  int max = find_maximum(sorted, input2); // MODIFIED: USED TO HAVE TestAsInt as first parameter
  int min = find_minimum(sorted, input2); // MODIFIED: USED TO HAVE TestAsInt as first parameter
...
{
  #ifdef VERBOSE  // *** Has been modified to use the PRINTF macro as defined in platform.h
